...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function renderCamps(camps) {
        ...
        camps.forEach(camp => {
            newContent += `
                <div class="bg-white rounded-lg shadow-md overflow-hidden transform hover:-translate-y-1 transition-transform duration-300 group" onclick="window.location.href='info-camp-animateur.php?id=${camp.id}'" style="cursor: pointer;">
                    <div class="relative">
